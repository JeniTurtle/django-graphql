...
class GroupAdmin(object):
    search_fields = ('name',)
    ordering = ('name',)
    style_fields = {'permissions': 'm2m_transfer', 'menus': 'm2m_transfer'}
...
class UserAdmin(object):
    ...
    list_display = ['username', 'real_name', 'email', 'mobile', 'gender', 'is_staff', 'is_active', 'last_login',
                    'create_time']
    list_filter = ['is_superuser', 'is_staff', 'is_active', 'gender']
    search_fields = ['username', 'email', 'real_name', 'mobile']
    ordering = ('username',)
